...
### Tâche 1 : Se déplacer dans le répertoire de configuration

Naviguez vers le dossier des sites disponibles d'Apache2 :

`cd /etc/apache2/sites-available`{{execute}}

### Tâche 2 : Créer le fichier de configuration
...
### Tâche 3 : Activer le site et redémarrer Apache2

Activez le site grâce aux outils d'Apache :
